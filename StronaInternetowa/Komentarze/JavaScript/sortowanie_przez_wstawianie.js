function insertionSort(t) {
    var tab = [], S = "<span style='font-weight: bold; color: #9cdb4b'>Ciag przed sortowaniem:</span><br/>";
    for (var i = 0; i < t; i++) {
    ...
    S += "<br/><br/><span style='font-weight: bold; color: #9cdb4b'>Ciag po sortowaniu:</span><br/>";
    for (var i = 0; i < t; i++) {
        S += tab[i]+" ";
    }
    return S;
...
function callIS() {
 ...
 window.addEventListener('load', function(){
	document.getElementById("CALC").onclick=callIS;
});